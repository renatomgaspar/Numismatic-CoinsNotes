<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/base_template.Master" AutoEventWireup="true" CodeBehind="new_usertype.aspx.cs" Inherits="Numismatic_CoinsNotes.Pages.new_usertype" %>
            ...
            <div id="contact-form">
                <div class="">
                    <fieldset>
                        ...
                        <asp:TextBox ID="tb_type" runat="server" placeholder="User Type..."></asp:TextBox>
                    </fieldset>
                </div>
                 <div class="">
                     <fieldset>
