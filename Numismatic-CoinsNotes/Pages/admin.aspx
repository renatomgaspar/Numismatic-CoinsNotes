        ...
        <div class="row properties-box">
          <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
            <div class="item">
              ...
              <h4><a href="manage_numismatics.aspx">Manage Users</a></h4>
                <hr />
              <div class="main-button">
                <a href="manage_numismatics.aspx">Go to Page</a>
              </div>
              ...
              <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
                <div class="item">
                  ...
                  <h4><a href="manage_numismatics.aspx">Manage Users Types</a></h4>
                    <hr />
                  <div class="main-button">
                    <a href="manage_numismatics.aspx">Go to Page</a>
                  </div>
              ...
              <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
                <div class="item">
                  ...
                  <h4><a href="manage_numismatics.aspx">Statistics</a></h4>
                    <hr />
                  <div class="main-button">
                    <a href="manage_numismatics.aspx">Go to Page</a>
                  </div>
