<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/base_template.Master" AutoEventWireup="true" CodeBehind="update_condition.aspx.cs" Inherits="Numismatic_CoinsNotes.Pages.update_condition" %>
            ...
            <div class="container">
                <div id="contact-form">
                    <div class="">
                     ...
                     <div class="">
                         <fieldset>
                            <asp:Button ID="btn_update_condition" class="orange-button" runat="server" Text="Update" OnClick="btn_update_condition_Click" />
